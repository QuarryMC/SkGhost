...
class EvtBlockBreak : SkriptEvent() {
    ...
    companion object {
        init {
            ...
            EventValues.registerEventValue(
                GhostBreakEvent::class.java,
                ChunkedStage::class.java, object : Getter<ChunkedStage?, GhostBreakEvent?>() {
                    override operator fun get(e: GhostBreakEvent?): ChunkedStage? {
                        if (e == null) return null
            ...
            EventValues.registerEventValue(
                GhostBreakEvent::class.java,
                ChunkedView::class.java, object : Getter<ChunkedView?, GhostBreakEvent?>() {
                    override operator fun get(e: GhostBreakEvent?): ChunkedView? {
                        if (e == null) return null
